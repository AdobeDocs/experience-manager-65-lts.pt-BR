---
title: Plug-in Maven para pacote de conteúdo do Adobe
...
O plug-in Maven do pacote de conteúdo do Adobe implanta os pacotes construídos no AEM e automatiza as tarefas que você normalmente executaria no Gerenciador de pacotes do AEM.
