...
1. [Implemente seus componentes usando um código que internacionalize cadeias de caracteres.](/help/sites-developing/i18n-dev.md) O código identifica as cadeias de caracteres a serem traduzidas e seleciona o idioma a ser apresentado no tempo de execução.
