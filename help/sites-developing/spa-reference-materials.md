...
## Referências da API do SPA JavaScript{#spa-javascript-api-references}

A seguir estão as referências disponíveis da API do JavaScript dos módulos NPM para a estrutura SDK do editor SPA do AEM.
