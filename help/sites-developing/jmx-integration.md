...
O exemplo de MBean a seguir fornece informações sobre o repositório do CRX. A interface usa a anotação Descrição para fornecer informações ao console JMX.
