...
A Adobe substituiu o Editor de SPA por [o AEM versão 6.5 LTS do GA](/help/release-notes/release-notes.md#deprecated-and-removed-features), o que significa que não serão feitos mais aprimoramentos ou atualizações em seus SDKs. A Adobe incentiva você a usar o [Editor universal](/help/sites-developing/universal-editor/introduction.md) para qualquer novo projeto headless, a fim de aproveitar as vantagens das mais recentes inovações da AEM.
