...
1. Navegue até a pasta desejada e selecione um ou mais ativos.
   ...
   Se você pesquisar ativos usando a caixa OmniSearch, poderá selecionar vários filtros do painel **[!UICONTROL Filtros]** para refinar sua pesquisa.
