...
Os componentes estão disponíveis ao [editar uma página](/help/sites-authoring/editing-content.md). Agrupe os componentes por sua área funcional principal (o grupo de componentes) para ajudar na filtragem.
...
* **WeRetail Commerce**: inclui componentes comerciais, como carrinhos e grades de produtos
...
## Componentes - principais áreas {#components-major-areas}
...
* Se a página for baseada no modelo editável moderno recomendado, você pode [alterar o modelo](/help/sites-authoring/templates.md), habilitá-lo ou desabilitá-lo e editar parâmetros para componentes específicos.
* Se a página for baseada em um modelo estático, você poderá usar o [modo de design](/help/sites-authoring/default-components-designmode.md#enable-disable-components) para habilitá-lo ou desabilitá-lo e editar parâmetros para componentes específicos.
