...
Quando os horários de ativação/desativação forem configurados, você verá ícones e informações adicionais relacionados aos horários de ativação/desativação nas [exibições de lista e cartão do Console Sites](/help/sites-authoring/basic-handling.md#views), bem como na [exibição de linha do tempo do painel lateral do console.](/help/sites-authoring/basic-handling.md#timeline)
