...
description: As tarefas envolvidas na criação de uma página de conteúdo no Adobe Experience Manager 6.5 LTS.
...
>[!NOTE]
>
>Esta seção aborda as tarefas envolvidas na criação de uma página de conteúdo. Há muitos recursos adicionais estritamente relacionados à criação de páginas, abordados em outras seções do [Guia de Criação](/help/sites-authoring/first-steps.md).
