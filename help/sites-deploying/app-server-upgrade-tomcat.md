...
# Etapas de atualização para instalações do servidor de aplicativos (Tomcat - Sidegrade) {#upgrade-steps-for-application-server-installations-tomcat}

>[!NOTE]
>
>Esta página descreve o procedimento de atualização do AEM 6.5 para o AEM 6.5 LTS no Tomcat. Para atualizar do AEM 6.5 LTS para o AEM 6.5 LTS Servicepack [consulte isto](/help/sites-deploying/app-server-upgrade-tomcat-inplace.md)
...
* **Servidor Tomcat**: as versões do servidor Tomcat para AEM 6.5 LTS com suporte são **10.0.x** e **10.1.x**.
...
1. Instale o Java 17/Java 21 e verifique se ele está instalado corretamente executando o comando:
...
1. Revise os parâmetros de início do servidor do AEM e atualize os parâmetros de acordo com os requisitos do sistema. Consulte [Considerações sobre Java 17/Java 21](/help/sites-deploying/custom-standalone-install.md#java-considerations) para obter mais informações
1. Implante o recém-baixado 6.5 LTS WAR no servidor Tomcat usando o Java 17/Java 21 e inicie o servidor AEM 6.5 LTS Tomcat executando:
