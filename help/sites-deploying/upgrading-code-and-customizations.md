...
* No AEM 6.5.x, se as APIs públicas e obsoletas forem necessárias, você pode usar incluir jar único, `uber-jar-6.5.x-apis-with-deprecations.jar` no arquivo `pom.xml`.
