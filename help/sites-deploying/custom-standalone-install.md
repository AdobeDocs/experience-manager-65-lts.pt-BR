...
### Considerações sobre o Java 17 {#java-considerations}

Se você estiver executando o Oracle Java 17, outras opções deverão ser adicionadas à linha de comando ao iniciar o AEM.

Abaixo está um exemplo de como os parâmetros JVM adicionais devem parecer ao iniciar o AEM no Java 17:
