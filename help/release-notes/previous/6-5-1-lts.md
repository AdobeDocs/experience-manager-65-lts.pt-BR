...
* Oracle Java™ 17/21 (64 bits) (Para obter mais detalhes, consulte mais detalhes na seção [Suporte ao Java](#java-support).
...
Os usuários sofreram corrupção do repositório durante a compactação online se a compactação offline tivesse sido executada anteriormente no repositório JCR. Um `SegmentNotFoundException` (SNFE) pode ocorrer neste cenário. Isso pode causar a corrupção do repositório.
...
>[!NOTE]
>
> Para qualquer operação de execução do oak, use o [oak-run 1.78.1-B006 jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) (vinculado acima).
