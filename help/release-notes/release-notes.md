...
description: Encontre informações sobre a versão atual do Adobe Experience Manager 6.5 LTS, Service Pack 1.
...
| Data | 21 de agosto de 2025 <!-- UPDATE FOR EACH NEW RELEASE --> |
| URL de download | [Distribuição de software](https://artifactory.corp.adobe.com/artifactory/maven-aem-release-local/com/adobe/aem/cq-quickstart/6.6.1/cq-quickstart-6.6.1.jar) |
...
#### IU Clássica{#sites-classicui-65-lts-sp1}
...
* Corrigido um erro de configuração de várias partes que ocorria durante uploads de pacotes do AEMFD no Tomcat 11 com JDK 17, atualizando a configuração do servidor para oferecer suporte a instalações de pacotes grandes sem disparar falhas de análise. (GRANITE-58327)
...
>[!NOTE]
>
> Para instalações novas do AEM 6.5 LTS, as definições de índice devem ser instaladas separadamente. Para obter mais informações, consulte [este artigo](/help/sites-deploying/pre-upgrade-maintenance-tasks.md#index-definitions).
...
### Falha de conexão do Dispatcher com o recurso somente SSL {#ssl-only-feature}
