...
* Para obter instruções detalhadas de atualização, consulte o [Guia de Atualização para AEM Forms 6.5 LTS SP1 em JEE](https://experienceleague.adobe.com/pt-br/docs/experience-manager-65-lts/content/forms/upgrade-aem-forms/upgrade)
