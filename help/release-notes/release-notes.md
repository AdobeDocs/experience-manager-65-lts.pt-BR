...
| Granite | Não há suporte para `crx2oak`. | Escolha a versão relevante do [Oak-upgrade](https://mvnrepository.com/artifact/org.apache.jackrabbit/oak-upgrade) | 6.5 LTS GA |
...
| `We.Retail` | Não há suporte para o site de exemplo `We-retail`. | Nenhuma substituição disponível. | 6.5 LTS GA |
