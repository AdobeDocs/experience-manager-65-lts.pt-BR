...
* Para obter instruções detalhadas de atualização, consulte o [Guia de atualização para o AEM Forms 6.5 LTS SP1 em JEE](https://experienceleague.adobe.com/en/docs/experience-manager-65-lts/content/forms/upgrade-aem-forms/upgrade)
