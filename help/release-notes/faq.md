...
## Minhas personalizações e integrações existentes serão afetadas se eu atualizar para o AEM 6.5 LTS?
...
## O que são os Service Packs do AEM 6.5 LTS?

Os Service Packs do AEM 6.5 LTS são uma atualização cumulativa que inclui todas as correções e melhorias feitas no AEM 6.5 LTS desde o lançamento inicial. É recomendável aplicar o service pack mais recente para garantir que sua instância do AEM esteja atualizada com os recursos e patches de segurança mais recentes.

## Estou atualmente no AEM 6.5, posso atualizar diretamente para o AEM 6.5 LTS Service Pack sem atualizar para a versão AEM 6.5 LTS GA?

Sim, você pode atualizar diretamente do AEM 6.5 para qualquer Service Pack do AEM 6.5 LTS. É recomendável revisar as [notas de versão](/help/release-notes/release-notes.md) e a [atualização para a seção AEM 6.5 LTS](/help/sites-deploying/upgrade.md).

## Atualmente estou no AEM 6.5 LTS GA, preciso fazer alterações no código para atualizar para os Service Packs do AEM 6.5 LTS?

Não, não é necessário fazer alterações no código para atualizar do AEM 6.5 LTS para o AEM 6.5 LTS Service Packs. No entanto, é sempre recomendável revisar as [notas de versão](/help/release-notes/release-notes.md) e testar suas personalizações e integrações em um ambiente de preparo antes de aplicar o service pack à sua instância de produção.

## Quero começar com uma nova configuração do AEM 6.5 LTS. Posso começar diretamente com o AEM 6.5 LTS Service Pack?

Sim, você pode configurar diretamente um novo AEM 6.5 LTS Service Pack sem configurar o build AEM 6.5 LTS GA. É recomendável revisar as [notas de versão](/help/release-notes/release-notes.md) e a seção [Instalação Autônoma Personalizada](/help/sites-deploying/custom-standalone-install.md) para obter mais detalhes.
