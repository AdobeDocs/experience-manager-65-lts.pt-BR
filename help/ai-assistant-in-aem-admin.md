...
1. Na página **Grupos de usuários** do **Assistente de IA no AEM**, clique na guia **Usuários** e em **Adicionar usuários**.
   ...
   ![Página grupos de usuários do Assistente de IA no AEM mostrando a guia Usuários e o botão Adicionar usuários](/help/assets/assets-ai/ai-assistant-add-users.png)
