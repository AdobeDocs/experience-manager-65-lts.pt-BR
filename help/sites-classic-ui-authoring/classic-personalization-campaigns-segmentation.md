...
description: A segmentação é uma consideração importante ao criar uma campanha. Normalmente, é necessário ter segmentos já definidos antes de iniciar a campanha.
contentOwner: User
