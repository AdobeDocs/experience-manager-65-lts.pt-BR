...
+ Forms {#forms}
   ...
   + Ajuda do administrador para AEM Forms no JEE {#administrator-help}
      ...
      + Conexão com um sistema de gerenciamento de conteúdo {#connect-content-management-system}
         ...
         + [Configuração do conector para IBM® FileNet](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
         + [Configuração do conector para o Gerenciador de conteúdo IBM®](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
      ...
      + Configuração do Forms Workflow{#configure-forms-workflow}
         ...
         + [Visão geral do Forms Workflow](/help/forms/using/admin-help/overview-9.md)
   ...
   + Referência do desenvolvedor {#developer-reference}
      ...
      + Programação com o AEM Forms no JEE {#programming-aem-forms-jee}
         ...
         + Início rápido da API Java - Exemplos de código {#java-api-quick-start-code-examples}
            ...
            + [QuickStart da API Java do Serviço de Credencial (SOAP)](/help/forms/developing/credential-service-java-api-quick.md)
         ...
         + Execução de operações de serviço usando APIs {#performing-service-operations-using-apis}
            ...
            + [Conversão de Postscript em documentos do PDF](/help/forms/developing/converting-postscript-pdf-documents.md)
            ...
            + [Trabalhar com Forms com códigos de barras](/help/forms/developing/barcoded-forms.md)
            + [Trabalhar com credenciais](/help/forms/developing/credentials.md)
            + [Trabalhar com documentos do PDF/A](/help/forms/developing/pdf-a-documents.md)
            + [Trabalhar com utilitários do PDF](/help/forms/developing/pdf-utilities.md)
            + [Trabalhar com utilitários do XMP](/help/forms/developing/xmp-utilities.md)
   ...
   + Resolução de problemas {#troubleshooting}
      ...
      + [Processamento de documentos mesmo que o servidor do AEM Forms não esteja totalmente ativo e em execução](/help/forms/using/processing-documents-even-if-aem-forms-server-not-fully-up.md)
   ...
   + Documentação herdada {#legacy-documentation}
      ...
      + [Geração e trabalho com hashes no PDF forms dinâmico](/help/forms/developing/hashing-forms.md)
...
+ Implementação {#implementing}
   ...
   + Implantando {#deploying}
      ...
      + Atualização para o AEM 6.5 LTS {#upgrading}
         ...
         + [Compatibilidade com versões anteriores no AEM 6.5 LTS](/help/sites-deploying/backward-compatibility.md)
