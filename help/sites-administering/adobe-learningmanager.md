...
Para obter mais informações, consulte o [pacote do site de referência do Adobe Learning Manager (site de referência do ALM) para o AEM Sites](https://experienceleague.adobe.com/pt-br/docs/learning-manager/using/integration/aem-sites/adobe-learning-manager-integration-aem).
