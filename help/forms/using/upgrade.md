...
* AEM 6.5.17.0 para AEM Forms 6.5 LTS
* AEM 6.5.18.0 para AEM Forms 6.5 LTS
* AEM 6.5.19.0 para AEM Forms 6.5 LTS
* AEM 6.5.20.0 para AEM Forms 6.5 LTS
* AEM 6.5.21.0 para AEM Forms 6.5 LTS
* AEM 6.5.22.0 para AEM Forms 6.5 LTS
* AEM 6.5.23.0 para AEM Forms 6.5 LTS

### AEM Forms LTS no JEE

O diagrama a seguir exibe os caminhos de atualização disponíveis para o AEM Forms LTS no JEE:

![Atualização do JEE 6.5](do-not-localize/jee-upgrade-6-5.svg)

Você pode executar uma atualização direta de:

* AEM 6.5.23.0 Forms no JEE

#### Como atualizar o Adobe Experience Manager Forms (AEM Forms) no JEE? {#how-do-i-upgrade-aem-forms-on-jee}

Para PDFs de atualização passo a passo (JBoss turnkey, servidor único e cluster), consulte [Fluxo de trabalho de instalação e atualização para o AEM Forms no JEE](/help/forms/using/aem-forms-jee-installation-upgrade-documentation.md).
