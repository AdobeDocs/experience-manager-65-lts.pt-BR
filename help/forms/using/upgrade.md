...
Consulte o artigo [Instruções de instalação do AEM 6.5 Forms Service Pack](https://experienceleague.adobe.com/docs/experience-manager-65-lts/release-notes/aem-forms-current-service-pack-installation-instructions.html) para instalar o Service Pack mais recente do ambiente JEE.
