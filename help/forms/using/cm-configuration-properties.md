...
description: Este tópico explica como editar o Asset Composer com configurações específicas da solução.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Largura mínima a ser aplicada no campo de marcador/número ao usar Listas numeradas além de números romanos.</td>
   <td>8,0 mm</td>
   <td>Qualquer número</td>
  </tr>
  <tr>
   <td><p>Largura mínima de números romanos</p> </td>
   <td><p>Largura mínima a ser aplicada ao marcador/campo de número ao usar números romanos.</p> </td>
   <td><p>12,7 mm</p> </td>
   <td><p>Qualquer número</p> </td>
  </tr>
  <tr>
   <td>Tipo de representação</td>
   <td>O tipo de representação que o aplicativo usa para renderizar a pré-visualização da correspondência. </td>
   <td>Representação do HTML</td>
   <td>Representação do HTML/Representação do PDF</td>
  </tr>
  <tr>
   <td><p>Ativar CCR PDF em destaque</p> </td>
   <td><p>Ativa o realce no PDF do aplicativo.</p> </td>
   <td><p>verdadeiro</p> </td>
   <td><p>verdadeiro / falso</p> </td>
  </tr>
  <tr>
   <td><p>Tipo de realce do público alvo</p> </td>
   <td><p>Tipo de destaque do Target no aplicativo.</p> </td>
   <td><p>borda</p> </td>
   <td><p>borda / preenchimento / nenhum</p> </td>
  </tr>
  <tr>
   <td><p>Cor de realce do público alvo</p> </td>
   <td><p>Cor de destaque do Target no aplicativo.</p> </td>
   <td><p>90;155;245</p> </td>
   <td><p>Qualquer cor do RGB no formato R;G;B</p> </td>
  </tr>
  <tr>
   <td><p>Tipo de realce de conteúdo</p> </td>
   <td><p>Tipo de destaque de conteúdo no aplicativo.</p> </td>
   <td><p>Preenchimento</p> </td>
   <td><p>borda / preenchimento / nenhum</p> </td>
  </tr>
  <tr>
   <td><p>Cor de realce do conteúdo</p> </td>
   <td><p>Cor de destaque do conteúdo no aplicativo.</p> </td>
   <td><p>210;225;245</p> </td>
   <td><p>Qualquer cor do RGB no formato R;G;B</p> </td>
  </tr>
  <tr>
   <td><p>Tipo de realce de campo</p> </td>
   <td><p>Tipo de destaque de campo no aplicativo.</p> </td>
   <td><p>preenchimento</p> </td>
   <td><p>borda / preenchimento / nenhum</p> </td>
  </tr>
  <tr>
   <td><p>Cor de realce do campo</p> </td>
   <td><p>Cor de destaque do campo no aplicativo.</p> </td>
   <td><p>210;225;245</p> </td>
   <td><p>Qualquer cor do RGB no formato R;G;B</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Tipo de envio do PDF (tipo de PDF gerado ao enviar a partir da solicitação).</p> </td>
  ...
  <tr>
   ...
   <td><p>Quando ativado, ele lida automaticamente com as possíveis inconsistências nas Atribuições de cartas.</p> </td>
   <td><p>verdadeiro</p> </td>
   <td><p>verdadeiro / falso</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Especifica um formato de exibição específico de localidade para dados.</p> </td>
  ...
  <tr>
   ...
   <td><p>Editar formato dos dados. Usado ao gravar dados como Cadeia de caracteres ou analisar dados de Cadeia de caracteres.</p> </td>
   <td><p>locale=en_US; dateFormat=dd-MM-yyyy; numberDecimalSeparator=.; numberGroupSeparator=,; numberUseGroupSeparator=true</p> </td>
   <td>--<p> </p> </td>
  </tr>
  <tr>
   <td><p>Gerenciar instâncias de carta ao publicar</p> </td>
   <td><p>Ativar/desativar a funcionalidade de correspondência (aplicável somente ao Servidor de publicação).</p> </td>
   <td><p>falso</p> </td>
   <td><p>verdadeiro / falso</p> </td>
  </tr>
  <tr>
   <td><p>Ativar auditoria</p> </td>
   <td><p>Habilitar / Desabilitar a funcionalidade de auditoria. Quando false, os logs de auditoria para todas as ações são desabilitados.</p> </td>
   <td><p>falso</p> </td>
   <td><p>verdadeiro / falso</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Ativar/desativar a funcionalidade de auditoria para criar ativos.</p> </td>
   <td><p>falso</p> </td>
   <td><p>verdadeiro / falso</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Especifique o Número máximo de letras a serem mantidas no cache.</p> <p>A alteração desse valor resulta na limpeza do cache <code>in-memory</code>.</p> </td>
   <td><p>100</p> </td>
   <td><p>Qualquer valor numérico</p> </td>
  </tr>
  <tr>
   <td><p>Ativar cache de cartas</p> </td>
   <td><p>Habilitar / Desabilitar o cache de letras.</p> <p>A alteração desse valor resulta na limpeza do cache <code>in-memory </code>.</p> </td>
   <td><p>verdadeiro</p> </td>
   <td><p>verdadeiro / falso</p> </td>
  </tr>
  <tr>
   <td><p>Ordem dos elementos de dados</p> </td>
   <td><p>Mantém os elementos de dados em ordem na interface de acordo com a sequência em Carta.</p> </td>
   <td><p>verdadeiro</p> </td>
   <td><p>verdadeiro / falso</p> </td>
  </tr>
  <tr>
   <td><p>Recarga de suporte</p> </td>
   <td><p>Habilitar/desabilitar o suporte ao recarregamento em cartas renderizadas no lado do servidor.</p> <p>A desativação melhora o desempenho de renderização da correspondência.</p> </td>
   <td><p>falso</p> </td>
  ...
  <tr>
   ...
   <td>Opções de compatibilidade do formato configname : configvalue separado por vírgula.</td>
