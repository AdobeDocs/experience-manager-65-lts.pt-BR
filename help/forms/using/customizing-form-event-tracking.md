...
Na configuração padrão do formulário do AEM, se um usuário gastar mais de 60 segundos em um campo, um evento `fieldvisit` será acionado e os detalhes do campo serão enviados para o Adobe Analytics. Você pode personalizar a linha de base do Rastreamento de tempo de campo em Configuração do AEM Forms Analytics no console Configuração do AEM (/system/console/configMgr) para aumentar ou diminuir o tempo limite.
