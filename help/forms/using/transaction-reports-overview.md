...
![exemplo-transação-relatório-autor-1](assets/sample-transaction-report-author-1.png)
...
![topologia de publicação de autor simples](assets/simple-author-publish-topology.png)
...
* Habilite a opção **Mostrar transações somente a partir da publicação** na instância do autor para exibir transações cumulativas de todas as instâncias de publicação. Você também pode exibir relatórios de transações em cada instância de publicação para transações reais somente nessa instância de publicação específica.
