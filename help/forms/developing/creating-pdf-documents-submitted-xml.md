...
Para criar um documento não interativo do PDF com dados XML enviados e armazená-los no documento do PDF no Content Services (desaprovado), execute as seguintes tarefas:
