---
title: Desmontar um documento do PDF usando a API do serviço Web
description: Desmontar um documento do PDF usando a API de serviço do Assembler
contentOwner: admin
...
# Desmontar um documento do PDF usando a API do serviço Web {#disassemble-a-pdf-document-usingthe-web-service-api}
