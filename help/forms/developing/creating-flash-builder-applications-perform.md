...
### Criando o aplicativo cliente {#creating-the-client-application}
...
### Criando o arquivo ISSOManager.as {#creating-the-issomanager-as-file}
...
### Criação do arquivo SSOEvent.as {#creating-the-ssoevent-as-file}
