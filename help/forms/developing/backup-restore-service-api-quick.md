---
title: API de Serviço de Backup e Restauração Inicializações Rápidas
description: Saiba como os Quick Starts da API de backup e restauração do AEM Forms permitem processos eficientes de criação e restauração de backup.
contentOwner: admin
