...
## Início rápido (modo SOAP): definir permissões do Content Services usando a API Java (obsoleto) {#quick-start-soap-mode-setting-content-services-permissions-using-the-java-api-deprecated}
