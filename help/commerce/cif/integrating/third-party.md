...
# Integração do AEM e de terceiros ao Commerce usando o Commerce integration framework {#aem-third-party}
...
A Adobe recomenda usar o [Adobe I/O Runtime](https://developer.adobe.com/apis/experienceplatform/runtime.html) para a camada de integração. Ele está incluído no complemento CIF para terceiros. Como funciona com uma abordagem semelhante a um microsserviço, é adequado para integrar facilmente várias soluções.
